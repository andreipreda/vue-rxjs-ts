...
var toSubscriber_1 = __webpack_require__(345);
...
var data = __webpack_require__(69);
exports.selectType$ = new Rx.BehaviorSubject('manufacturers');
exports.selectCountry$ = new Rx.BehaviorSubject('uk');
exports.selectGender$ = new Rx.BehaviorSubject('f');
exports.selectLocation$ = new Rx.BehaviorSubject('country');
// capture any change in the select options from the user
var filterChange$ = Rx.Observable
    .merge(exports.selectType$, exports.selectCountry$, exports.selectGender$, exports.selectLocation$)
    .distinctUntilChanged();
// transform the changes into a query object
var filterState$ = Rx.Observable
    .zip(exports.selectType$, exports.selectCountry$, exports.selectGender$, exports.selectLocation$, function (type, country, gender, location) { return ({ type: type, country: country, gender: gender, location: location }); });
var zipAll$ = filterChange$.switchMapTo(filterState$);
// filter only needed fields to query for
// open console tab to see how the query prepared for a possible api
var filterByType$ = zipAll$.switchMap(function (filters) {
    switch (filters.type) {
        case 'manufacturers': {
            return Rx.Observable.of({ type: filters.type, country: filters.country, gender: filters.gender });
        }
        case 'sizes': {
            return Rx.Observable.of({ type: filters.type, country: filters.country });
        }
        case 'months': {
            return Rx.Observable.of({ type: filters.type, location: filters.location, country: filters.country });
        }
        default: {
            return Rx.Observable.of(filters);
        }
    }
}).do(function (query) { return console.log('query for', query); });
// query orders this will be a call to a server in a real app sending the right query
exports.orders$ = filterByType$.switchMap(function (query) {
    // this would be a real db query in a real case with a call to the server
    switch (query.type) {
        case 'manufacturers': {
            switch (query.gender) {
                case 'm': {
                    return Rx.Observable.of(data.genderMOrders);
                }
                case 'f': {
                    return Rx.Observable.of(data.genderFOrders);
                }
                default: {
                    return Rx.Observable.of(data.manOrders);
                }
            }
            ;
        }
        case 'sizes': {
            switch (query.country) {
                case 'uk': {
                    return Rx.Observable.of(data.ukOrders);
                }
                case 'austria': {
                    return Rx.Observable.of(data.austriaOrders);
                }
                default: {
                    return Rx.Observable.of(data.sizeOrders);
                }
            }
        }
        case 'months': {
            switch (query.location) {
                ...
                case 'country': {
                    return Rx.Observable.of(data.monthOrders);
                }
                default: {
                    return Rx.Observable.of(data.monthOrders);
                }
    ...
    .do(function (orders) { return console.log('orders returned for query above', orders); });
...
var Vue = __webpack_require__(347);
var mechanism_1 = __webpack_require__(38);
// sales person selector view
exports.productFilter = new Vue({
    el: '#filter',
    data: {
    ...
    watch: {
        selectType: function (newVal) { return mechanism_1.selectType$.next(newVal); },
        selectCountry: function (newVal) { return mechanism_1.selectCountry$.next(newVal); },
        selectGender: function (newVal) { return mechanism_1.selectGender$.next(newVal); },
        selectLocation: function (newVal) { return mechanism_1.selectLocation$.next(newVal); }
    },
...
var not_1 = __webpack_require__(344);
var filter_1 = __webpack_require__(47);
/**
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(37), __webpack_require__(70)))
...
mechanism_1.orders$.subscribe(
// workaround for vuejs lack of direct typescript support
function (orders) { return views_1.ordersTable.orders = orders; });
